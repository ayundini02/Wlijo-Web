        ...
        <div class="row">
          <div class="col-md-12 col-lg-8">
            <div class="title-single-box">
              <h1 class="title-single breadcrumb-item">About</h1>
              <h3 class="breadcrumb-item active" aria-current="page">
                  Visi &amp; Misi Wlijo</h3>
            </div>
          </div>
          ...
          <div class="about-section-box"><div class="container">
              <br/><br/>
                  <div class="row"><div class="col-lg-6 col-md-4 text-center">
                      <div class="inner-column"><h4>Visi</h4> 
                      <p>Wlijo memberikan layanan belanja sayuran dengan kualitas
                        ...
                        <div class="col-lg-6 col-md-4 text-center">
                            <div class="inner-column"><h4>Misi</h4> 
